...
const handler = async (req, res) => {
    if (req.method === "POST") {
        try {
            ...
            const {  TrackingID, trackingUrl,  TrackingCost} = req.body;
            
            // Find the card in the database based on the provided cardid
            const foundCard = await Tracking.findOne({ TrackingID: TrackingID });
            ...
            foundCard.trackingUrl = trackingUrl;
            foundCard.TrackingCost = TrackingCost;
